#CREATED, CODING, AUTHOR BY: MR D4PLU17
#TEAM SUPPORT: InDoNeSiA CYBER ErRoR SyStEm
#VERSION: SIMPEL DAN MUDAH  #PYTHON PROGRAM
#THANKS YOU
...
if __name__ == "__main__":
	print (R+"   _ _             _ _  _ _ __     _ ______   ")
	print (R+"   \  \    _ _    /  / |   _ _|     |          \ ")
	print (R+"    \  \  /   \  /  /  |  |_ _      |     ___/  ") 
	print (R+"     \  \/  /\ \/ /  |   _ _|      |     |_    ")
	print (R+"      \    /  \   /    |     |_ _     |        \   ") 
	print (R+"       \--/    --/     |_ _ _ _¦     |______\ ")                           ")
	print (G+"   AUTHOR CODING BY: MR D4PLU17")
	print (G+"   TYPE: SIMPEL DAN MUDAH")
	print (G+"   TEAM: ICES")
	print (G+"   TEAM SUPPORT: InDoNeSiA CYBER ErRoR SyStEm")
	print (G+"   VERSION: 7.7.7")
	print (W+43*"=")
