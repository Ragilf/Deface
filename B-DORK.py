#CREATED, CODING, AUTHOR BY: MISTER BLACK CYBER
#TEAM SUPPORT: MARIANAS WEB TEAM 2K05
#VERSION: SIMPEL TOOLS FOR CHECKING DORKING WEBSITE #PYTHON PROGRAM
...
if __name__ == "__main__":
	print (R+"  __________.__                 __             ________                __      ")
	print (R+"  \______   \  | _____    ____ |  | __         \______ \   ___________|  | __  ")
	print (R+"   |    |  _/  | \__  \ _/ ___\|  |/ /  ______   |    | \ /  _ \_  __ \  |/ /  ")
	print (R+"   |    |   \  |__/ __ \\  \___|    <   /_____/   |    `  (  <_> )  | \/    <   ")
	print (R+"   |______  /____(____  /\___  >__|_ \          /_______ /\____/|__|  |__|_ \  ")
	print (R+"          \/          \/     \/     \/                 \/                  \/  ")
	print (G+"   AUTHOR CODING BY: MISTER BLACK CYBER")
	print (G+"   TYPE: SIMPLE TOOLS CHECK DORKING WEBSITE")
	print (G+"   TEAM: BLACK CYBER ANONYMOUS TEAM 2K07")
	print (G+"   TEAM SUPPORT: MARIANAS WEB TEAM 2K05")
	print (G+"   VERSION: 6.6.6")
	print (W+43*"=")
